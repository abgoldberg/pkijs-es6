...
export default class RSAPrivateKey
{
	...
	{
		const jwk = {
                        n: toBase64(arrayBufferToString(this.modulus.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        e: toBase64(arrayBufferToString(this.publicExponent.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        d: toBase64(arrayBufferToString(this.privateExponent.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        p: toBase64(arrayBufferToString(this.prime1.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        q: toBase64(arrayBufferToString(this.prime2.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        dp: toBase64(arrayBufferToString(this.exponent1.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        dq: toBase64(arrayBufferToString(this.exponent2.valueBlock.valueHex).replace(/^\x00+/, ''), true, true),
                        qi: toBase64(arrayBufferToString(this.coefficient.valueBlock.valueHex).replace(/^\x00+/, ''), true, true)
		};
